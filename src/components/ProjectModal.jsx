...
function ProjectModal() {
    ...
    const [addProject] = useMutation(ADD_PROJECT, { variables: { name, description, clientId, status},
      // Update the cache
      update(cache, { data: {addProject}}) {    // Read the project info
        const { projects } = cache.readQuery({ query: GET_PROJECTS });
        cache.writeQuery({                      // Write the project info
          query: GET_PROJECTS,
    ...
    if (error) return 'Somethinf eent wrong'
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h1 className="modal-title fs-5" id="ProjectModalLabel">New Project</h1>
              ...
              <div className="modal-body">
                <form onSubmit={onSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <select name="" id="status" value={status} className="form-select"
